<section class="content">
    <div class="row">
        <div class="col-md-8">
            ...
            <img src="<?php echo base_url(); ?>/assets/uploads/<?= getkopskpd($this->session->userdata('skpd'));?>" alt="" class="img-fluid">
            </div>
                <div class="card-body pad">
                    ...
                    <div class="mb-3">
                    <form role="form" action="<?php echo site_url('sppd_luar/savelhpd/'.$id);?>" method="post">
