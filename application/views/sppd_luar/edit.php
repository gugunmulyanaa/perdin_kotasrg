<section class="content">
    <div class="container-fluid">
            ...
            <form role="form" action="<?php echo site_url('sppd_luar/editspt'); ?>" method="post">
                <div class="card card-info card-outline">
                <div class="card-header">
                    <h3 class="card-title">
                        <a href="<?php echo base_url('sppd_luar');?>"
                        class="btn btn-info btn-sm"><i class="fas fa-arrow-left"></i> Kembali</a>
                        <span class="btn btn-dark btn-sm">Nomor Surat : 800/<?php echo nomor($id); ?>/DKPP/<?php echo date("Y"); ?></span>
                    </h3>
                </div>
                    <div class="card-body">
                        <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="form-group">
                                <label for="exampleInputPassword1">Wilayah Tujuan</label>
                                <select class="form-control select2" name="jarak" style="width: 100%;" data-placeholder="Pilih Wilayah Kab./Kota Tujuan" required>
                                <option></option>
                                    <?php foreach($wilayah as $e):; ?>
                                    <option value="<?php echo $e->id_jarak; ?>" <?php if ($getrow['jarak_id'] == $e->id_jarak){echo "selected";} ?>>
                                    <?php echo $e->nama_kota; ?>-<?php echo $e->nama_provinsi; ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12">                        
                            <div class="form-group">
                                <label for="exampleInputPassword1">Tempat Tujuan</label>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="form-group">
                                <label for="exampleInputPassword1">Kendaraan Digunakan</label>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <select class="form-control" required name="paket">
                                    ...
                                    <option value="2" <?php if($getrow['jenis_paket']=='2'){echo "selected";} ?>>Paket NON FULL Board</option>
                                    <option value="3" <?php if($getrow['jenis_paket']=='3'){echo "selected";} ?>>Paket FULL Board</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="form-group">
                                <label for="exampleInputPassword1">Acara/Maksud Perjalanan Dinas</label>
