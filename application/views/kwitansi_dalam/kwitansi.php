        ...
        <div class="col-lg-8 col-md-12 col-sm-12">
            <div class="card card-primary card-outline">
                ...
                <?php if(getjumpegawai($id) >= 1 && cekpegawai($id) == getkepalaskpd($this->session->userdata('skpd')) && getstatus($id) >= 2){
                    echo '<a href="'.site_url('cetak/cetaksppdsetda/'.$id).'" 
                    ...
                    echo '<a href="'.site_url('cetak/cetaksppd/'.$id).'"
                    class="btn bg-purple btn-sm"><i class="fas fa-print"></i> Cetak Visum</a>';
                }else{
                    echo'';
                }?>
                ...
                <table id="example" class="table table-hover table-responsive" style="width:100%">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            Transport : 1 X <?php echo rupiah($row->uang_transport); ?> = <?php echo rupiah($row->tot_transport); ?><br>
                        ...
                        <td>
                            <center>
                            <a href="<?php echo site_url('kwitansi_dalam/hapuskwitansi/'.$row->id); ?>" 
                            class="btn btn-danger btn-sm tombolhapus"><i class="fas fa-trash"></i> Hapus</a><br>
                            <a href="<?php echo site_url('kwitansi_dalam/edit/'.$row->id); ?>" 
...
<div class="modal fade" id="modal_add_asn">
    <div class="modal-dialog modal-lg">
        ...
        <form class="form-horizontal" action="<?php echo site_url('Kwitansi_dalam/add_auto_kwitansi/'.$id); ?>" method="post">
