<section class="content">
    ...
    <div class="col-lg-8 col-md-8 col-sm-12">
        ...
        <div class="card">
            ...
            <h3 class="card-title">Cetak Rekapitulasi SPPD Luar Daerah</h3>
            ...
            <form class="form-horizontal" role="form" action="<?php echo site_url('Rekap_luar/cetakrekap'); ?>" method="post">
            ...
            <div class="card-footer">
                ...
                <i class="fas fa-print"></i> Cetak Rekapitulasi Luar Daerah
