    ...
    <div class="row">
        <div class="col-lg-8 col-md-12 col-sm-12">
            <div class="card card-primary card-outline">
                ...
                <a href="<?php echo base_url('kwitansi_luar/kwitansi/'.$getrow['sppd_id']);?>"
                class="btn btn-info btn-sm"><i class="fas fa-arrow-left"></i> Kembali</a>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                <form role="form" action="<?php echo site_url('Kwitansi_luar/editkwitansi/'.$id); ?>" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <p class="text-danger"><i>Jangan melewati biaya maksimal pada SSH <?=rupiah($harian);?></i></p>
                    </div>
                    <div class="form-group">
                        ...
                        <p class="text-danger"><i>Biaya maksimal pada SSH Jika Transport menggunakan Mobil <?=rupiah($transport);?></i></p>
                    </div>
                    <div class="form-group">
                        ...
                        <p class="text-danger"><i>Jangan melewati biaya maksimal pada SSH <?=rupiah($representatif);?></i></p>
                    </div>
                    <div class="form-group">
                        ...
                        <p class="text-danger"><i>Jangan melewati biaya maksimal pada SSH <?= rupiah($hotel);?></i></p>
                    </div>
                </div>
                <!-- /.card-body -->
