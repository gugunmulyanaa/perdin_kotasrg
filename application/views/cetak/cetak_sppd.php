        ...
        <table class="table table-bordered" style="width:100%;margin-top:0px">
            <tbody>
                ...
                <tr>
                    ...
                    <td style="width:47%"><p style="margin:4px;"><br>a. <?php echo $skpd['singkatan_opd']; ?> Kota Serang <br>b. <?php echo getkodeprog($kwitansi['program_id']); ?>.<?php echo getkodekeg($kwitansi['kegiatan_id']); ?>.5.2.2.15.01<br>c. Tahun <?php echo tahun_indo($kegiatan['tgl_cetak']); ?></p></td>
                </tr>
            </tbody>
        </table>
        <br>
    ...
    <section>
        <table class="table table-bordered" style="width:100%;margin-top:0px">
            <tbody>
                ...
                <tr>
                    <td valign="top" colspan="3" style="border-left-style:hidden;">
                        <p style="text-align:center">Pejabat yang berwenang/</p>
                        <p style="text-align:center">Pejabat lainnya yang ditunjuk</p>
                        <br><br>
                        <p style="text-align:center"><u><?php echo getdepan($skpd['kepala_opd']); ?> <?php echo getpegawai($skpd['kepala_opd']); ?> <?php echo getbelakang($skpd['kepala_opd']); ?></u></p>
                        <p style="text-align:center">NIP. <?php echo getnip($skpd['kepala_opd']); ?></p>
                    </td>
