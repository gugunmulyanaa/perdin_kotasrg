        ...
        <table class="table table-bordered" style="width:100%;margin-top:0px">
            <tbody>
                ...
                <tr>
                    ...
                    <td style="width:47%"><p style="margin:4px;">a. <?php echo getpangkat(getgolpeg($kwitansi['pegawai_id'])); ?> <?php echo getgol(getgolpeg($kwitansi['pegawai_id'])); ?><br><br>b. <?php echo getjab($kwitansi['pegawai_id']); ?><br>c. Dalam Daerah</p></td>
                </tr>
                <tr>
