...
<body>
    <section>
        ...
        <div style="text-align:center;">
            ...
            <span>Nomor : 800/<?php echo nomor($kegiatan['id']); ?>/<?php echo $setda['singkatan_opd']; ?>/<?php echo date("Y"); ?></span>
            <br/><br>
            <p style="padding-left:30px;text-align:justify;">Berdasarkan surat undangan nomor <?php echo $kegiatan['no_surat_msk']; ?> dari <?php echo $kegiatan['nama_satker']; ?> perihal <?php echo $kegiatan['perihal']; ?>, dengan ini Sekretaris Daerah Kota Serang :</p>
            <h4>
        ...
        <p style="padding-left:30px;">Untuk <?php echo $kegiatan['acara']; ?>, yang dilaksanakan pada :</p>
        ...
        <p style="padding-left:30px;">Demikian surat perintah ini berlaku sejak tanggal dikeluarkan dan agar dilaksanakan sebagaimana mestinya.</p><br>
        <table class="table table-bordered" style="border-color:white;width:100%;">
            <tbody>
                <tr>
        ...
        <table class="table table-bordered" style="border-color:white;width:100%;">
            <tbody>
                <tr>
                    ...
                    <td style="width:45%">
                    <p style="text-align:center;margin:0px;"><b>SEKRETARIS DAERAH,</b><br><br><br><br></p>
                    </td>
                </tr>
                <tr>
                    <td style="width:55%"></td>
                    <td style="width:45%">
                    <p style="text-align:center;margin:0px;"><b><u><?php echo getdepan($setda['kepala_opd']); ?> <?php echo getpegawai($setda['kepala_opd']); ?>, <?php echo getbelakang($setda['kepala_opd']); ?></u></b><br></p>
                    </td>
                </tr>
                <tr>
                    <td style="width:55%"></td>
