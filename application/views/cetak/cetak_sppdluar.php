        ...
        <table class="table table-bordered" style="width:100%;margin-top:0px">
            <tbody>
                <tr>
                    ...
                    <td style="width:47%;"><p style="margin:4px;"><?php echo getjab($skpd['kepala_opd']); ?><br><?php echo getdepan($skpd['kepala_opd']); ?> <?php echo getpegawai($skpd['kepala_opd']); ?> <?php echo getbelakang($skpd['kepala_opd']); ?></p></td>
                </tr>
                <tr>
                ...
                <td style="width:6%"><p style="margin:4px;">3.</p></td>
                    ...
                    <td style="width:47%"><p style="margin:4px;">a. <?php echo getpangkat(getgolpeg($kwitansi['pegawai_id'])); ?> <?php echo getgol(getgolpeg($kwitansi['pegawai_id'])); ?><br><br>b. <?php echo getjab($kwitansi['pegawai_id']); ?><br>
                    c. Luar Daerah</p></td>
                </tr>
                <tr>
        ...
        <table class="table table-bordered" style="border-color:white;width:100%;">
            <tbody>
                ...
                <tr>
                    ...
                    <td style="width:1%;border-color:white"><p style="margin:0px;">:</p></td>
                    <td style="width:27%;border-color:white"><p style="margin:0px;"><?php echo tgl_indo($kegiatan['tgl_cetak']); ?></p></td>
                </tr>
            </tbody>
        </table>
        <table class="table table-bordered" style="border-color:white;width:100%;">
            ...
            <tr>
                    ...
                    <p style="text-align:center;margin:0px;border-color:white"><b><?php echo getjab($skpd['kepala_opd']); ?></b><br><br><br><br></p>
                    </td>
                </tr>
                <tr>
                    <td style="width:55%;border-color:white"></td>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td valign="top" colspan="3" style="border-right-style:hidden;">
                        <p>An. Kepala</p>
                        <br>
                        <p style="text-align:center"><u><?php echo getdepan($skpd['kepala_opd']); ?> <?php echo getpegawai($skpd['kepala_opd']); ?> <?php echo getbelakang($skpd['kepala_opd']); ?></u></p>
                        <p style="text-align:center">NIP. <?php echo getnip($skpd['kepala_opd']); ?></p>
                    </td>
                </tr>
                <!--------------------------- Break Line 1------------------------------------->
                <tr>
                ...
                <tr>
                    <td valign="top" colspan="6" style="border-left-style:hidden;border-right-style:hidden;">
                        ...
                        <p>Pejabat yang berwenang menerbitkan SPPD, pegawai yang melakukan perjalanan dinas, para pejabat yang mengesahkan tanggal barang/tiba, serta bendaharawan bertanggungjawab berdasarkan peraturan-peraturan keuangan Negara apabila negara menderita rugi akibat kesalahan, kelalaian dan kealpaannya.</p>
                    </td>
                </tr>
                <!--------------------------- Break Line 7------------------------------------->
            </tbody>
